...
<div id="fullpage">
  ...
  <div class="newBox section">
  	<div class="container">
        <div class="products row">
          <h2 class="font_s fw_b">PRODUCTS</h2>
          <ul class="row">
            <li class="mattress col-md-3">
 ...
 <script>
   new fullpage('#fullpage',{
     navigation:true,
     navigationTooltips:['PRODUCTS', 'SERVICE', 'CUSTOMER SUPPORT', 'APP', 'EVENT', 'SNS']
   });
 </script>
